  ...
  // ============================================
  {
    ...
    children: [
      ...
      // ============================================
      {
        ...
        children: [
          { path: '', pathMatch: 'full', redirectTo: 'discussion' },
          {
            path: 'discussion',
            loadComponent: () =>
              import('./pages/community/discussion/discussion').then(m => m.DiscussionComponent),
            data: { title: 'Community - Discussion' },
          },
          {
            path: 'chat',
            loadComponent: () =>
              import('./pages/community/chat/chat').then(m => m.ChatComponent),
            data: { title: 'Community - Chat' },
          },
          {
            path: 'poll',
            loadComponent: () =>
              import('./pages/community/poll/poll').then(m => m.PollComponent),
            data: { title: 'Community - Poll' },
          },
        ],
      },
      {
